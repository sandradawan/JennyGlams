...
const styles = {
  ...
  outline:
    "border border-ink/25 text-ink hover:border-rose hover:text-rose",
  ghost:
    "text-ink hover:text-rose",
};

/** WhatsApp click-to-chat button with an optional pre-filled message. */
export default function BookButton({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-medium tracking-wide transition-colors duration-300 ${styles[variant]} ${className}`}
    >
      <svg
        width="16"
        height="16"
